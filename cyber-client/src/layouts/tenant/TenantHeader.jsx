// src/layouts/tenant/TenantHeader.jsx
...
const TenantHeader = ({ onMenuClick }) => {
  ...
  const handleLogout = () => { if (user) logout(); if (isAdmin) adminLogout(); setDropdownOpen(false); };

  const displayName = user?.ownerName || user?.name || 'User';
